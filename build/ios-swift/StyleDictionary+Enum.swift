...
public enum StyleDictionaryEnum {
    ...
    public static let globalDanger = #dc3545
    public static let globalDark = #212529
    public static let globalLight = #f8f9fa
    public static let globalPrimary = #0d6efd
    public static let globalSecondary = #6c757d
    public static let globalSpace1 = 0.25rem
    public static let globalSpace2 = 0.5rem
    public static let globalSpace3 = 1rem
    public static let globalSpace4 = 1.5rem
    public static let globalSpace5 = 3rem
    public static let globalSuccess = #198754
